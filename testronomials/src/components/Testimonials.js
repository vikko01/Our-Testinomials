...
const Testimonials = (props) => {
    ...
    return (
        ...
        items-center mt-10 p-10 transition-all rounded-md duration-700 hover:shadow-xl">
            ...
            <div className="mt-6">
            <button 
            onClick={surpriseHandler} className="bg-violet-400 hover:bg-violet-500 transition-all duration-200
